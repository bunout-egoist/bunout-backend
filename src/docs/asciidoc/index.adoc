...
==== Request
include::{snippets}/notification-controller-test/update-all-notifications/path-parameters.adoc[]
include::{snippets}/notification-controller-test/update-all-notifications/http-request.adoc[]

==== Response
include::{snippets}/notification-controller-test/update-all-notifications/http-response.adoc[]

=== 알람 단일 업데이트

==== Request
include::{snippets}/notification-controller-test/update-notification/path-parameters.adoc[]
include::{snippets}/notification-controller-test/update-notification/http-request.adoc[]

==== Response
include::{snippets}/notification-controller-test/update-notification/http-response.adoc[]
