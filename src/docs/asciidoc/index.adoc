...
==== Request
include::{snippets}/dashboard-controller-test/get-completed-quest-detail/path-parameters.adoc[]
include::{snippets}/dashboard-controller-test/get-completed-quest-detail/http-request.adoc[]

==== Response
include::{snippets}/dashboard-controller-test/get-completed-quest-detail/http-response.adoc[]

==== Request (조회 날짜가 형식에 맞지 않을 경우)
include::{snippets}/dashboard-controller-test/get-completed-quest-detail_-invalid-local-date-type/http-request.adoc[]

==== Response
include::{snippets}/dashboard-controller-test/get-completed-quest-detail_-invalid-local-date-type/http-response.adoc[]
